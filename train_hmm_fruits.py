...
predicted_labels2 = model2.predict_files(['data/test_data/apple15.wav'])
print(f'predicted label {predicted_labels2}')

predicted_labels3 = model2.predict_files(['data/test_data/output.wav'])
print(f'predicted label {predicted_labels3}')

predicted_labels4 = model2.predict_files(['data/test_data/pineapple_risto3.wav'])
